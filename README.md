...
- Переменные окружения:
  ...
  - Необязательно: `INITIAL_REVIEW_MINUTES`, `REVIEW_SCAN_INTERVAL_MS`, `REVIEW_BATCH_SIZE`, `AWAITING_GRADE_TIMEOUT_MS`.
...
3. В разделе **Variables** задайте `BOT_TOKEN`, `CHAT_ID`, `DASHBOARD_SECRET`, при необходимости `INITIAL_REVIEW_MINUTES`, `REVIEW_SCAN_INTERVAL_MS`, `REVIEW_BATCH_SIZE`, `AWAITING_GRADE_TIMEOUT_MS` и/или `PORT`.
