...
4. Добавьте бота администратором в канал `CHAT_ID`.
5. Отправьте тестовое сообщение боту, нажмите «Добавить в обучение» — через заданный интервал он должен появиться в канале.
